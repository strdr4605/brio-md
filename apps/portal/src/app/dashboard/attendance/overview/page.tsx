...
export default function AttendanceOverviewPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          ...
          <div className="inline-flex rounded-xl bg-slate-100 p-1 border border-slate-200/80">
            <Link
              ...
              className="px-3 py-1.5 rounded-lg text-xs font-bold text-slate-600 hover:text-slate-900 transition"
            >
              Catalog Jurnal
            </Link>
      ...
      <div className="bg-white p-3.5 sm:p-4 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col sm:flex-row sm:items-center gap-2.5 sm:gap-3">
        {/* Course Filter */}
